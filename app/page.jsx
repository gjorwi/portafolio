  ...
  return (
    <>
      <div className='grid grid-cols-1 md:grid-cols-12 h-full relative '>
        <div className='col md:col-span-7 z-40 w-full flex flex-col justify-center items-center md:items-start lg:items-end lg:pr-10'>
